...
export const defaultManagedPages: ManagedPage[] = [
  {
    ...
    slug: "",
    path: "/",
    seoTitle: "Автосервис в Минске на Солтыса — СТО | Teorema Service",
    seoDescription:
    ...
    faq: [
      ...
      faq(
        "home-where",
        "Где находится Teorema Service?",
        "Автосервис в Минске на ул. Солтыса, 108, корпус 3 — микрорайон Дражня, Партизанский район. Как проехать, смотрите на карте на главной и на странице контактов."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Плановое ТО легковых автомобилей и LCV в Минске, ул. Солтыса, 108, корпус 3. Запись по телефону или через форму на сайте.",
    h1: "Техническое обслуживание автомобилей",
    subtitle:
      "Плановое обслуживание легковых автомобилей и лёгкого коммерческого транспорта.",
    intro:
      "Плановое обслуживание помогает вовремя заменить расходники и заметить неисправность до того, как она остановит автомобиль. Принимаем легковые машины и лёгкий коммерческий транспорт, включая небольшие грузовики. Сервис на ул. Солтыса, 108, корпус 3 — удобно из Дражни и Партизанского района.",
    blocks: [
      block(
        "what",
    ...
    faq: [
      ...
      faq(
        "maintenance-where",
        "Где пройти техническое обслуживание в Минске?",
        "ТО делаем в Teorema Service на ул. Солтыса, 108, корпус 3. Это Партизанский район, микрорайон Дражня."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Ремонт легковых автомобилей и LCV в автосервисе на Солтыса: от текущих неисправностей до работ любой сложности.",
    ...
    intro:
      "Ремонтируем легковые автомобили и лёгкий коммерческий транспорт. Берёмся за текущие неисправности и за работы, где нужен больший объём: осмотр, согласование и выполнение в одном сервисе. Принимаем в боксе на ул. Солтыса, 108, корпус 3.",
    blocks: [
      block(
        "scope",
        "Какой ремонт делаем",
    ...
    faq: [
      ...
      faq(
        "repair-where",
        "Где отремонтировать автомобиль в Дражне?",
        "Ремонт легковых и лёгкого коммерческого транспорта — в Teorema Service, ул. Солтыса, 108, корпус 3."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Кузовной ремонт и стапель в Минске на ул. Солтыса, 108, корпус 3. Оценка по фото или на осмотре.",
    h1: "Кузовной ремонт",
    subtitle:
      "Восстановление кузова после повреждений. Стапельные работы для восстановления геометрии кузова.",
    intro:
      "Восстанавливаем кузов после повреждений. На стапеле возвращают геометрию кузова — его правильную форму и положение основных элементов. Кузовные работы делаем в Минске на ул. Солтыса, 108, корпус 3.",
    blocks: [
      block(
        "stapel",
        "Стапель",
    ...
    faq: [
      ...
      faq(
        "body-where",
        "Где сделать кузовной ремонт на Солтыса?",
        "Стапель и кузовной ремонт — в Teorema Service, ул. Солтыса, 108, корпус 3, микрорайон Дражня."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Покраска кузова и отдельных деталей в камере Teorema Service, Партизанский район Минска.",
    h1: "Покраска автомобиля",
    subtitle: "Покраска кузова и отдельных деталей в покрасочной камере.",
    intro:
      "Красим кузов и отдельные детали в покрасочной камере. Так окраска проходит в контролируемых условиях: подготовка, нанесение покрытия и сушка. Камера стоит в нашем сервисе в Дражне.",
    blocks: [
      block(
        "booth",
        "Покрасочная камера",
    ...
    faq: [
      ...
      faq(
        "paint-where",
        "Где покрасить автомобиль в Минске на Солтыса?",
        "Покрасочная камера — в Teorema Service на ул. Солтыса, 108, корпус 3."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Шиномонтаж и сезонная смена шин в Дражне: ул. Солтыса, 108, корпус 3.",
    h1: "Шиномонтаж",
    subtitle: "Сезонная смена шин и шиномонтажные работы.",
    intro:
      "Делаем сезонную смену шин и шиномонтажные работы. На оборудовании сервиса выполняем монтаж, демонтаж и балансировку колёс. Шиномонтаж — на ул. Солтыса, рядом с микрорайоном Дражня.",
    blocks: [
      block(
        "season",
        "Сезонная смена",
    ...
    faq: [
      ...
      faq(
        "tires-where",
        "Где сделать шиномонтаж в Дражне?",
        "Сезонную смену шин и балансировку делаем в Teorema Service, ул. Солтыса, 108, корпус 3."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Заправка автокондиционера в Teorema Service на Солтыса. Запись по телефону или через форму.",
    h1: "Заправка автокондиционера",
    subtitle: "Заправка системы кондиционирования автомобиля.",
    intro:
      "Заправляем систему кондиционирования автомобиля. Если нужны другие работы с кондиционером, уточните их при обращении — не обещаем заранее то, что не подтверждено. Заправку делаем в сервисе на Солтыса, корпус 3.",
    blocks: [
      block(
        "what",
        "Что делаем",
    ...
    faq: [
      ...
      faq(
        "ac-where",
        "Где заправить автокондиционер в Минске на Солтыса?",
        "Заправку системы кондиционирования делаем в Teorema Service на ул. Солтыса, 108, корпус 3."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Полировка кузова в автосервисе на Солтыса: блеск ЛКП и менее заметные мелкие поверхностные дефекты.",
    h1: "Полировка кузова",
    subtitle:
      "Полировка лакокрасочного покрытия для восстановления блеска и уменьшения заметности мелких поверхностных дефектов.",
    intro:
      "Полируем лакокрасочное покрытие, чтобы вернуть блеск и сделать менее заметными мелкие поверхностные дефекты. Глубокие царапины полировка не убирает. Полируем кузов в том же боксе на Солтыса.",
    blocks: [
      block(
        "result",
    ...
    faq: [
      ...
      faq(
        "polish-where",
        "Где отполировать кузов в Минске?",
        "Полировку ЛКП делаем в Teorema Service на ул. Солтыса, 108, корпус 3, в Дражне."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Примеры работ Teorema Service в Минске на Солтыса: ремонт, кузовной ремонт, покраска, шиномонтаж и полировка.",
    h1: "Наши работы",
  ...
  },
  {
    ...
    seoDescription:
      "Стоимость услуг автосервиса на Солтыса определяем после осмотра. Для ремонта можно отправить фотографии.",
    h1: "Цены на услуги",
    subtitle:
  ...
  },
  {
    ...
    slug: "about",
    path: "/about",
    seoTitle: "О сервисе Teorema Service в Минске на Солтыса",
    seoDescription:
      "Teorema Service — автосервис в Минске на ул. Солтыса, 108, корпус 3 (Дражня, Партизанский район). Легковые автомобили и лёгкий коммерческий транспорт.",
    h1: "О сервисе",
    subtitle:
      "Автосервис в Минске на Солтыса: легковые автомобили и лёгкий коммерческий транспорт.",
    intro:
      "Teorema Service находится в Минске на ул. Солтыса, 108, корпус 3 — микрорайон Дражня, Партизанский район. Принимаем легковые автомобили и лёгкий коммерческий транспорт, включая небольшие грузовики. В одном месте можно сделать обслуживание и ремонт, кузовные работы на стапеле, покраску в камере, шиномонтаж, заправку кондиционера и полировку кузова.",
    blocks: [],
    faq: [
      faq(
        "about-where",
        "В каком районе Минска вы находитесь?",
        "В Партизанском районе, микрорайон Дражня. Адрес: ул. Солтыса, 108, корпус 3."
      )
    ],
  ...
  },
  {
    ...
    slug: "contacts",
    path: "/contacts",
    seoTitle: "Контакты Teorema Service — Минск, Солтыса 108, корпус 3",
    seoDescription:
      "Teorema Service, г. Минск, ул. Солтыса, 108, корпус 3, микрорайон Дражня. Телефон +375 44 518 94 32. График 9:00–18:00, воскресенье — выходной.",
    h1: "Контакты",
    ...
    blocks: [
      block(
        "how-to-find",
        "Как добраться",
        "Сервис в Партизанском районе Минска, микрорайон Дражня: ул. Солтыса, 108, корпус 3. Ближайшие остановки — «Дражня» и «Переулок Солтыса». На карте на этой странице — точка въезда."
      )
    ],
    faq: [
      faq(
        "contacts-where",
        "Где находится Teorema Service?",
        "г. Минск, ул. Солтыса, 108, корпус 3. Микрорайон Дражня, Партизанский район."
      ),
      faq(
        "contacts-hours",
        "Когда вы работаете?",
        "С понедельника по субботу с 9:00 до 18:00. Воскресенье — выходной."
      )
    ],
  ...
  },
  {
    ...
    seoDescription:
      "Онлайн-запись в Teorema Service на ул. Солтыса, 108, корпус 3: имя, телефон и нужная услуга.",
